...
class Mpesa:
    ...
    @staticmethod
    def stk_push(phone, amount, account_reference=None, transaction_desc='', is_paybill=True):
        """
        ...
        try:
            return OnlineCheckout.objects.create(
                ...
                account_reference=account_reference if account_reference else phone,
                transaction_description=transaction_desc if transaction_desc != '' else uuid.uuid4().hex,
